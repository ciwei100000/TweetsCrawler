...
public class TwitterCrawler3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String nameFileName = "./TweetsTest3";
        ...
        if (!restart) {
            ...
            try {
                ...
                for (User user : users) {
                    ...
                    if (user.getFollowersCount() > 200 && user.getStatusesCount() > 1000 && !user.isProtected() && user.getId() % num == 2) {
                        ...
                        try {
                            ...
                            for (User user : users) {
                                ...
                                if (!userids.containsKey(user.getId()) && !user.isProtected() && user.getFollowersCount() > 200
                                        && user.getStatusesCount() >= 1000 && user.getId() % num == 2) {
