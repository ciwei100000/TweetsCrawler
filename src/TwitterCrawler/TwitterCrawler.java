...
public class TwitterCrawler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String nameFileName = "./TweetsTest";
        String Consumerkey = "1fehb8awFzhHnqrA60131abfU";
        ...
        if (!restart) {
            ...
            try {
                ...
                for (User user : users) {
                    ...
                    if (user.getFollowersCount() > 200 && user.getStatusesCount() > 1000 && !user.isProtected() && user.getId() % num == 0) {
                        ...
                        try {
                            ...
                            for (User user : users) {
                                ...
                                if (!userids.containsKey(user.getId()) && !user.isProtected() && user.getFollowersCount() > 200
                                        && user.getStatusesCount() >= 1000 && user.getId() % num == 0) {
